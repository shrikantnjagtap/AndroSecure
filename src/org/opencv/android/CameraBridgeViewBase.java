...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraBridgeViewBase(Context context, AttributeSet attrs) {
        ...
        TypedArray styledAttrs = getContext().obtainStyledAttributes(attrs, CameraBridgeViewBase);
        if (styledAttrs.getBoolean(CameraBridgeViewBase_show_fps, false))
            enableFpsMeter();

        mCameraIndex = styledAttrs.getInt(CameraBridgeViewBase_camera_id, -1);
